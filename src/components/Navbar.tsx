...
const Navbar = () => {
  ...
  const handleProfileUpdate = (updatedUser: { name?: string | null; email?: string | null; image?: string | null }) => {
    setLocalUser(prev => {
  ...
  return (
    ...
    {session?.user && localUser && ( // Keep modal structure but control visibility with isOpen
      <UserProfileModal
