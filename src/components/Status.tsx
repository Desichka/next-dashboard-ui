...
const Status: FC<StatusProps> = ({ options, selected, onChange }) => {
    ...
    return (
        <div ref={dropdownRef} className="relative inline-block text-left">
            ...
            {isOpen && (
                <div
                    className="absolute z-10 w-auto origin-top-right rounded-md bg-lightBgColor dark:bg-darkBgColor shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                >
                    <div className="py-1">
                        {options.map((option) => (
                            <button
