  ...
  return (
    <div className="p-8 space-y-4 bg-background text-foreground">
      ...
      <section>
        ...
        <p className="text-success-foreground bg-success p-1 rounded-sm inline-block">Success text on success background.</p>
        <p className="text-warning-foreground bg-warning p-1 rounded-sm inline-block">Warning text on warning background.</p>
        <p className="text-info-foreground bg-info p-1 rounded-sm inline-block">Info text on info background.</p>
      </section>
      ...
      <section>
        ...
        <div className="bg-card text-card-foreground p-4 rounded-lg shadow-md">
          This is a card component using card background and foreground colors, padding, and large border radius.
        </div>
      </section>
      ...
      <section>
        ...
        />
         <p className="text-sm text-muted-foreground mt-1">Uses input border, medium radius, and focus ring.</p>
      </section>
      ...
      <section>
        ...
        <button className="bg-primary text-primary-foreground hover:bg-primary-hover px-4 py-2 rounded-md">
         ...
         <p className="text-sm text-muted-foreground mt-1">Uses primary colors, hover state, padding, and medium radius.</p>
      </section>
      ...
      <section>
        ...
        <div className="border-2 border-border-subtle p-2 mt-2 rounded-md">Subtle border (thicker for visibility)</div>
      </section>
